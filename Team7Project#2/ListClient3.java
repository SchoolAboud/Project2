/*CS211, 5/18/2020, Team 7[Majd Chalak, Abdalrahman(Aboud) Shaath, William(Liam) Bryan, Joseph Helf, Richard Le],
This is a tester client for project #2, as you can see there is a lot of code, we really wanted to stress test our code, to help you navigate your way,
we've created a step by step list

1. Read the output first, it is made to help illustrate what the code is doing
   1a. The output is split up into two main tests(Integer and String
   1b. Those two main tests are split into two subtests(Array List, and Link List);
   1c. Once you finish reading the output, move on to step 2
   
2. Read the code in conjuction with the output, to make sure that our code works will
*/
...
public class ListClient3 {
    public static void main(String[] args) {
        ...
        AbstractList list1 = new ArrayList<Integer>(); // Creation of AbstractList[ArrayList]
        AbstractList list2 = new LinkedList<Integer>(); // Creation of AbstractList[LinkedList]
